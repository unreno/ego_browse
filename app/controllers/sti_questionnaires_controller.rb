class StiQuestionnairesController < ApplicationController
  ...
  private
    ...
    def sti_questionnaire_params
      params.require(:sti_questionnaire).permit(:date_of_visit, :participant_id, :staff_person, :stitest_ev, :stitest, :stitest_other, :stitest_last, :stitest_reason_a, :stitest_reason_b, :stitest_reason_c, :stitest_reason_d, :stitest_reason_e, :stitest_reason_f, :stitest_reason_g, :stitest_reason_h, :stitest_reason_i, :stitest_reason_other, :stitest_locn, :stitest_rslt, :notest_reason, :stitest_future, :stipercrisk, :stistigma)
    end
end
