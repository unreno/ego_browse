class EligibilityScreeningsController < ApplicationController
  ...
  private
    ...
    def eligibility_screening_params
      params.require(:eligibility_screening).permit(:how_learned, :how_learned_other, :age, :sex, :race, :race_other, :children, :seen_pcp, :marital, :tested_hiv, :tested_hiv_result, :partner_count, :injection_drugs, :partner_injection_drugs, :partner_noninjection_drugs, :partner_hiv_positive, :partner_other_partners, :partner_traded_sex, :partner_man_men, :eligible_q_8_15, :where_live, :where_live_other, :willing_to_refer, :matched_to_ego, :eligible, :name_of_screener, :location_of_screening, :date_of_screening, :time_of_screening, :referred_for_interview, :referred_appointment_date, :referred_appointment_time, :reason_for_refusal, :reason_for_refusal_other, :gender, :data_entry_name)
    end
end
