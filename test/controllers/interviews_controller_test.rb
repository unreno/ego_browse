...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post interviews_url, params: { interview: { active: @interview.active, complete_date: @interview.complete_date, completed: @interview.completed, start_date: @interview.start_date, studyId: @interview.studyId } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { active: @interview.active, complete_date: @interview.complete_date, completed: @interview.completed, start_date: @interview.start_date, studyId: @interview.studyId } }
